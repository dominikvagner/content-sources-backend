...
func mapVulnerability(issue JiraIssue) (Vulnerability, error) {
	if issue.Key == "" {
...
func linkedIssueKey(issue JiraIssue, label string) string {
	var links []issueLink
...
func parentIssueKey(issue JiraIssue) string {
